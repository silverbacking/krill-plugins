...
interface AllowlistConfig {
  configPath?: string;
  allowedSenders?: string[]; // MXIDs allowed to modify allowlist (e.g., Krill API bot)
  logger?: any;
}

let handlerConfig: AllowlistConfig = {};

/**
 * Initialize the allowlist handler
 */
export function initAllowlistHandler(config: AllowlistConfig): void {
 ...
 */
function getAllowlist(config: any): string[] {
 ...
 */
function setAllowlist(config: any, allowlist: string[]): any {
